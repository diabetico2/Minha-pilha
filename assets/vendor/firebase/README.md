...
Copie apenas o bundle resultante para `assets/vendor/firebase/firebase.js`. A cópia local permite ao service worker manter o SDK disponível offline após o primeiro carregamento.
